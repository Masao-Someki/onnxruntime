...
static_assert(std::string_view(ORT_VERSION) == "1.11.1-espnet_onnx", "ORT_Version change detected, please follow below steps to ensure OrtApi is updated properly");
