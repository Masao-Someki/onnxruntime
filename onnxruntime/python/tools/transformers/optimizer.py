...
from onnx_model_espnet import ESPnetOnnxEncoder, ESPnetOnnxDecoder
...
MODEL_TYPES = {
    ...
    "espnet_transformer_encoder": (ESPnetOnnxEncoder, "pytorch", 1),
    "espnet_transformer_decoder": (ESPnetOnnxDecoder, "pytorch", 1),
}
